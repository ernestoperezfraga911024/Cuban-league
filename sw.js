const CACHE_NAME = 'cuban-league-v94-gnt-manager-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=94-20260729',
  './app.js?v=94-20260729',
  './data.json?v=94-20260729',
  './supabase-config.js?v=94-20260729',
  './admin.html',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=94-20260729'));
    return;
  }
