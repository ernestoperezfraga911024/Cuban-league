const CACHE_NAME = 'cuban-league-v110-copa-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=110-20260805',
  './app.js?v=110-20260805',
  './data.json?v=110-20260805',
  './supabase-config.js?v=110-20260805',
  './admin.html',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=110-20260805'));
    return;
  }
