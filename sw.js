const CACHE_NAME = 'cuban-league-v58-private-analytics-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=58-20260727',
  './app.js?v=58-20260727',
  './data.json?v=58-20260727',
  './supabase-config.js?v=58-20260727',
  './admin.html',
  './admin.css?v=58-20260727',
  './admin.js?v=58-20260727',
  './admin-manifest.json',
  './supabase.js',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=58-20260727'));
    return;
  }
