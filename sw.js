const CACHE_NAME = 'cuban-league-v88-manager-style-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=88-20260728',
  './app.js?v=88-20260728',
  './data.json?v=88-20260728',
  './supabase-config.js?v=88-20260728',
  './admin.html',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=88-20260728'));
    return;
  }
