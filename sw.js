const CACHE_NAME = 'cuban-league-v46-season-points-record-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=46-20260726',
  './app.js?v=46-20260726',
  './data.json?v=46-20260726',
  './supabase-config.js?v=46-20260726',
  './admin.html',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=46-20260726'));
    return;
  }
