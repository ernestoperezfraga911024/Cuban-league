const CACHE_NAME = 'cuban-league-v28-no-bottom-nav-pwa';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=28-20260723',
  './app.js?v=28-20260723',
  './data.json?v=28-20260723',
  './manifest.json',
...
self.addEventListener('fetch', event => {
  ...
  if (url.pathname.endsWith('/data.json')) {
    event.respondWith(networkFirst(request, './data.json?v=28-20260723'));
    return;
  }
